...
static Key keys[] = {
    ...
    /* Screenshot */
    { 0,                            XK_Print,   spawn,      SHCMD("$HOME/.scripts/area_screenshot.sh") },
    { ShiftMask,                    XK_Print,   spawn,      SHCMD("$HOME/.scripts/screenshot.sh") },
    //{ MODKEY|ShiftMask,             XK_Print,   spawn,      SHCMD("$HOME/.scripts/pixel.sh") }, // hex value corresponding to selected pixel
